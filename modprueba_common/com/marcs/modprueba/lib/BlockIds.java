...
public class BlockIds {
    ...
    public static final int TUNGSTEN_ORE_BLOCK_D = 500;
    public static final int TEST_SLAB_D = 501;
    public static final int TEST_SLAB_DOUBLE_D = 502;
    ...
    public static final int PORTABLE_BENCH_D = 507;
    //Ids de la config
    public static int TUNGSTEN_ORE_BLOCK;
    public static int TEST_SLAB;
    public static int TEST_SLAB_DOUBLE;
    ...
    public static int PORTABLE_BENCH;
}

...
public class EntityNukePrimed extends Entity{
    ...
    private void explode()
    {
        ...
        AxisAlignedBB aabb = AxisAlignedBB.getAABBPool().getAABB(this.posX, this.posY, this.posZ, this.posX + 1, this.posY + 1, this.posZ + 1).expand(50D, 50D, 50D);
        aabb.maxY = (double)this.worldObj.getHeight();
        @SuppressWarnings("rawtypes")
        List list = this.worldObj.getEntitiesWithinAABB(EntityLiving.class, aabb);
        @SuppressWarnings("rawtypes")

...
public class BlockNuke extends Block{
    ...
    public void onBlockDestroyedByExplosion(World par1World, int par2, int par3, int par4, Explosion par5Explosion)
    {
        ...
        {
            EntityNukePrimed entitynukeprimed = new EntityNukePrimed(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F), par5Explosion.func_94613_c());
            entitynukeprimed.fuse = par1World.rand.nextInt(entitynukeprimed.fuse / 4) + entitynukeprimed.fuse / 8;
            par1World.spawnEntityInWorld(entitynukeprimed);
        }
    }
    ...
    public void func_94391_a(World par1World, int par2, int par3, int par4, int par5, EntityLiving par6EntityLiving)
    {
        if (!par1World.isRemote)
        {
            if ((par5 & 1) == 1)
            {
                EntityNukePrimed entitynukeprimed = new EntityNukePrimed(par1World, (double)((float)par2 + 0.5F), (double)((float)par3 + 0.5F), (double)((float)par4 + 0.5F), par6EntityLiving);
                par1World.spawnEntityInWorld(entitynukeprimed);
                par1World.playSoundAtEntity(entitynukeprimed, "random.fuse", 1.0F, 1.0F);
            }
        }
    }
    ...
    {
        icons[0]= par1IconRegister.registerIcon(Reference.MOD_ID+":"+ModBlocks.blockNuke.getUnlocalizedName2()+"0");
        icons[1]= par1IconRegister.registerIcon(Reference.MOD_ID+":"+ModBlocks.blockNuke.getUnlocalizedName2()+"1");
        icons[2]= par1IconRegister.registerIcon(Reference.MOD_ID+":"+ModBlocks.blockNuke.getUnlocalizedName2()+"2");
    }
}
